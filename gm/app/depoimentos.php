...
<html lang="pt-br">
  <head>
    ...
    <title>Depoimentos - Gerencie Mais :: <?= $NOME_CLIENT ?></title>
  </head>
...
?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-md-3 mb-2">
                        <a href="depoimentos_.php?funcao=novo&urlRetorno=<?= $URL_ATUAL ?>" class = "botao botao-a-min b-pequeno float-end">Criar um novo</a>
                    </div>
                </div>
                ...
                ?>
                        ...
                        <div class="row ">
                            <div class="col-sm-9">
                                ...
                                <ul class="nav abas-navegacao">
                                  <li class="nav-item">
                                    <a class="nav-link <?= $abaAtual == "publicado" ? "active" : ""; ?>" href="depoimentos.php?aba=publicado&acao=lista">Publicados</a>
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link <?= $abaAtual == "lixeira" ? "active" : ""; ?>" href="depoimentos.php?aba=lixeira&acao=lista">Lixeira</a>
                                  </li>
                                </ul>
                    ...
                    $inicio =  ($limiteRegistro * $paginaRecebida) - $limiteRegistro;
                        ...
                        $seleciona = "SELECT * FROM depoimentos WHERE status = '$abaAtual' ORDER BY ordem DESC LIMIT $inicio, $limiteRegistro  ";
                    ...
                    <div class = "gm-box-item mb-2 mt-2">
                        <div class="row f-14">
                            <div class="col">
                                <span ><?= $registo['nome_completo'] ?></span><br>
                            </div>
                            ...
                            <div class="col col-sm-1">
                                <div class="dropdown ">
                                      ...
                                      <ul class="dropdown-menu f-14">
                                        <li><a class="dropdown-item" href="depoimentos_.php?funcao=editar&id=<?= $registo['id'] ?>&urlRetorno=<?= $URL_ATUAL ?>">Editar</a></li>
                                        <?php if($abaAtual != "lixeira"){ ?> 
                                        <li><a class="dropdown-item" href="depoimentos.php?botao=lixeira&id=<?= $registo['id'] ?>&urlRetorno=<?= $URL_ATUAL ?>">Mover para o lixo</a></li>
                                        <?php }elseif($abaAtual == "lixeira"){ ?> 
                                        <li><a class="dropdown-item" href="depoimentos.php?botao=restaurar&id=<?= $registo['id'] ?>&urlRetorno=<?= $URL_ATUAL ?>">Restaurar</a></li>
                                                  ...
                                                  <div class="modal-header">
                                                    ...
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                      ...
                                                      <div class="modal-body">
                                                        ...
                                                        <p class = "f-14">
                                                            Ao fazer essa ação, você irá excluir permanentemente o "<?= $registo['nome_completo'] ?>" da lixeira e não poderá recuperá-lo. Tem centeza que quer fazer esta ação?
                                                        </p>

                                                      </div>
                                                      <div class="modal-footer">
                                                        <button type="button" class="botao b-pequeno botao-b-min" data-bs-dismiss="modal">Cancelar</button>
                                                        <a href="depoimentos.php?botao=excluir&id=<?= $registo['id'] ?>&urlRetorno=<?= $URL_ATUAL ?>" type="button" class="botao b-pequeno botao-a-min">Sim! Excluir.</a>
                                                      </div>
                                                </div>
                                              </div>
                                            </div>
                   ...
                   <!-- caso esteja vzaio -->
                    ...
                    ?>
                        ...
                        <!-- caso esteja vzaio -->
                       <div class="centro p-5">                        
                            <p class = "f-16 negrito">Sem item para mostrar!</p>
                            <a href="destaques.php?funcao=novo&urlRetorno=<?= $URL_ATUAL ?>" class = "botao botao-a-min b-pequeno">Criar um depoimento</a><br>
                    ...
                    <nav class = "gm-paginacao mt-4">
                      <ul class="pagination pagination-sm justify-content-end">
                        <?php                        
                            ...
                            $contaRegisto = "SELECT COUNT(id) AS numeroAchado FROM depoimentos";
  ...
  //Edicao dos botoes
        ...
        if (isset($_GET['botao'])) {
            ...
            if ($acaoBotao == "lixeira") {
                //========
                $selecionaAcao = "UPDATE depoimentos SET status = 'lixeira' WHERE id = '$acoRotativo'";
            ...
            if ($acaoBotao == "restaurar") {
               ...
               // echo "Ok! Vamos ocultar conteúdo";
                $selecionaAcao = "UPDATE depoimentos SET status = 'publicado' WHERE id = '$acoRotativo'";
                $consultaAcao = $conexao -> prepare($selecionaAcao);
                $consultaAcao -> execute();
            ...
            if ($acaoBotao == "excluir") {
                ...
                // echo "Ok! Vamos ocultar conteúdo";
                $selecionaAcao = "DELETE FROM depoimentos WHERE id = '$acoRotativo'";
                $consultaAcao = $conexao -> prepare($selecionaAcao);
                $consultaAcao -> execute();
